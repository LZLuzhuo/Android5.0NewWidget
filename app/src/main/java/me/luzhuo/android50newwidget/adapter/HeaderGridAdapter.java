...
public class HeaderGridAdapter extends RecyclerView.Adapter<ViewHolder> {
	private final int TYPE_HEADER = 0x001, TYPE_ITEM = 0x002;
	private Context context;
	private int[] imageContents;

	public HeaderGridAdapter(Context context, int[] imageContents) {
		...
		public void setData(int position) {
			...
			switch (this.getItemViewType()){
				...
				case TYPE_ITEM:
					...
					/*ViewGroup.LayoutParams lp2 = item_image.getLayoutParams();
					lp2.width = width / 3;
					lp2.height = (int) (width / 3 / 0.75);
					item_image.setLayoutParams(lp2);*/
